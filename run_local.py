...
import os
import time
from aws_lambda_script.main import lambda_handler
...
def run_local():
    ...
    try:
        ...
        context = type('LambdaContext', (), {
            ...
            'invoked_function_arn': 'arn:aws:lambda:local:000000000000:function:tech-radar-lambda',
        ...
        print(f"REPORT RequestId: {request_id}\tDuration: {duration:.2f} ms\tBilled Duration: {int(duration)} ms\tMemory Size: 128 MB\tMax Memory Used: N/A")
